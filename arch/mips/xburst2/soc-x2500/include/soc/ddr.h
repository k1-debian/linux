...
#define DDRP_CMD_NRCOMP     (DDR_PHY_OFFSET + 0x2c0)
#define DDRP_CMD_PRCOMP     (DDR_PHY_OFFSET + 0x2c4)
#define DDRP_CK_NRCOMP      (DDR_PHY_OFFSET + 0x2c8)
#define DDRP_CK_PRCOMP      (DDR_PHY_OFFSET + 0x2cc)
