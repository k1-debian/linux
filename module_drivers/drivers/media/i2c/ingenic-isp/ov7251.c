...
static struct ov7251_win_size *ov7251_select_win(u32 *width, u32 *height)
{
...
int ov7251_g_frame_interval(struct v4l2_subdev *sd, struct v4l2_subdev_frame_interval *interval)
{
	struct ov7251_info *info = to_state(sd);
