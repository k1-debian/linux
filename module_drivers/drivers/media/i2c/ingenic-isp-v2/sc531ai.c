...
static int sc531ai_probe(struct i2c_client *client)
{
	...
	if (gpio_is_valid(gpio)) {
		...
		info->efsync.active_level =  INGENIC_ISP_GPIO_ACTIVE_LOW;
	}
	...
	*/
	...
	info->sd.entity.obj_type = MEDIA_ENTITY_TYPE_V4L2_SUBDEV;
...
static void sc531ai_remove(struct i2c_client *client)
{
