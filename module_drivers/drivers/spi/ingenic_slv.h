...
#define INGENIC_SPI_MODE0 4
#define INGENIC_SPI_MODE1 5
#define INGENIC_SPI_MODE2 6
#define INGENIC_SPI_MODE3 7
...
struct ingenic_sslv {
	...
	int (*txrx_bufs)(struct ingenic_sslv *spi, struct spi_ioc_transfer *t);
