...
static struct smart_config smart_cfg = {
	.dc_md = 0,
	.wr_md = 1,
...
static int panel_detect_id(struct mipi_dsim_lcd_device *dsim_dev, unsigned char *buf, int count)
{
	...
	//  ret = ops->cmd_write(master, set_max_return_packet_size);
