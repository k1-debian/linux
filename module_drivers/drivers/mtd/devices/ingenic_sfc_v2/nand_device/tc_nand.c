...
static struct ingenic_sfcnand_device *tc_nand;
static struct ingenic_sfcnand_base_param tc_param[TC_DEVICES_NUM] = {
...
static int __init tc_nand_init(void)
{
	...
	return ingenic_sfcnand_register(tc_nand);
}

fs_initcall(tc_nand_init);
