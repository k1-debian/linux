...
#define I2SDIV_MDIV_BIT     (27)    /* x2600 */
#define I2SDIV_MDIV_MASK    (0x1f << I2SDIV_MDIV_BIT)
...
/* For AICTFLR */
	...
	#define AICTFLR_REC_EXEN_BIT  (0)
	#define AICTFLR_REC_EXEN_MASK (0x1 << AICTFLR_REC_EXEN_BIT)
	#define AICTFLR_RPL_EXEN_BIT  (1)
	#define AICTFLR_RPL_EXEN_MASK (0x1 << AICTFLR_RPL_EXEN_BIT)
	#define AICTFLR_TFLTH_BIT   (16)
#else
...
/* aic fr / aic fr2 */
#ifdef CONFIG_SOC_X2600
#define __aic_enable_rec_exen(parent) \
	ingenic_aic_set_reg(parent, AICTFLR, 1, AICTFLR_REC_EXEN_MASK, AICTFLR_REC_EXEN_BIT)
#define __aic_disable_rec_exen(parent) \
	ingenic_aic_set_reg(parent, AICTFLR, 0, AICTFLR_REC_EXEN_MASK, AICTFLR_REC_EXEN_BIT)
#define __aic_enable_rpl_exen(parent) \
	ingenic_aic_set_reg(parent, AICTFLR, 1, AICTFLR_RPL_EXEN_MASK, AICTFLR_RPL_EXEN_BIT)
#define __aic_disable_rpl_exen(parent) \
	ingenic_aic_set_reg(parent, AICTFLR, 0, AICTFLR_RPL_EXEN_MASK, AICTFLR_RPL_EXEN_BIT)
#endif
...
#define __i2s_replay_is_enable(parent)  \
	ingenic_aic_get_reg(parent, AICCR, AICCR_ERPL_MASK, AICCR_ERPL_BIT)
#define __i2s_enable_replay(parent)             \
	ingenic_aic_set_reg(parent, AICCR, 1, AICCR_ERPL_MASK, AICCR_ERPL_BIT)
#define __i2s_record_is_enable(parent)  \
	ingenic_aic_get_reg(parent, AICCR, AICCR_EREC_MASK, AICCR_EREC_BIT)
...
#define __i2s_set_mdiv(parent, div) \
	ingenic_aic_set_reg(parent, I2SDIV, div, I2SDIV_MDIV_MASK, I2SDIV_MDIV_BIT)
