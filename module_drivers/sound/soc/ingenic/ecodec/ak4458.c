...
static const struct snd_kcontrol_new ak4458_snd_controls[] = {
	SOC_DOUBLE_R_TLV("AK4458 DAC1 Playback Volume", AK4458_03_LCHATT,
	                 AK4458_04_RCHATT, 0, 0xFF, 0, dac_tlv),
	SOC_DOUBLE_R_TLV("AK4458 DAC2 Playback Volume", AK4458_0F_L2CHATT,
	                 AK4458_10_R2CHATT, 0, 0xFF, 0, dac_tlv),
	SOC_DOUBLE_R_TLV("AK4458 DAC3 Playback Volume", AK4458_11_L3CHATT,
	                 AK4458_12_R3CHATT, 0, 0xFF, 0, dac_tlv),
	SOC_DOUBLE_R_TLV("AK4458 DAC4 Playback Volume", AK4458_13_L4CHATT,
...
static int ak4458_set_dai_mute(struct snd_soc_dai *dai, int mute, int stream)
{
	struct snd_soc_component *component = dai->component;
	struct ak4458_priv *ak4458 = snd_soc_component_get_drvdata(component);
	int nfs, ndt, ret, reg;
