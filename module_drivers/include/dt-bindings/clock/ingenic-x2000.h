#ifndef _DT_BINDINGS_CLOCK_X2000_H
#define _DT_BINDINGS_CLOCK_X2000_H
...
#define CLK_GATE_UART6      (CLK_ID_GATE + 42)
...
#define CLK_GATE_CIM_MCLK   (CLK_ID_GATE + 62)
#define CLK_CE_I2S0     (CLK_ID_GATE + 63)
#define CLK_CE_I2S1     (CLK_ID_GATE + 64)
#define CLK_CE_I2S2     (CLK_ID_GATE + 65)
#define CLK_CE_I2S3     (CLK_ID_GATE + 66)
#define CLK_NR_GATE     (67)
